...
const StartupForm = () => {
  ...
  const handleFormSubmit = async (prevState: any, formData: FormData) => {
    try {
      ...
      await formSchema.parseAsync(formValues); // zod validation
  ...
  return (
    <form action={formAction} className="startup-form">
      ...
      <div>
        ...
        <Input id="description" name="description" className="startup-form_textarea" required placeholder="Startup Description" />
